...
const steps={
  0:{phase:'시작 안내',title:'수행평가를 시작합니다',desc:'학번과 이름을 정확히 입력하고, 교사의 안내에 따라 수행평가를 시작하세요.',notice:'정답 하나를 찾는 활동이 아닙니다. <b>자료와 국가 상황을 근거로 왜 그렇게 판단했는지</b>가 중요합니다.'},
  ...
  3:{phase:'1차시 · 국가 입장 설계',title:'국제기후기금 100억 원을 배분하세요',desc:'모든 사업에 기본 10억 원이 있습니다. 남은 50억 원을 10억 원 단위로 추가 배분하세요.',notice:'총액은 반드시 100억 원입니다. <b>최소 한 사업 30억 이상, 한 사업은 10억 유지</b> 조건을 확인하세요.'},
