...
function resourceVisual(id){
 if(id==='structure')return `<div class="resourceVisual"><h3>🏗️ 6개 후보역 구조·설치 조건 비교</h3><p class="small muted">같은 엘리베이터 사업이라도 승강장 구조와 기존 시설에 따라 필요한 추가 대수와 비용이 달라집니다.</p><div class="tablewrap"><table><thead><tr><th>역</th><th>승강장·기존 구조</th><th>무단차 경로 완성에 필요한 추가 설치</th><th>대수</th><th>예상비</th></tr></thead><tbody><tr><td>새봄중앙역</td><td>상·하행이 분리된 측식 승강장</td><td>지상↔대합실 1대 + 상·하행 승강장 각 1대</td><td>3대</td><td>24억</td></tr><tr><td>복지센터역</td><td>하나의 섬식 승강장에서 양방향 이용</td><td>지상↔대합실 1대 + 대합실↔승강장 1대</td><td>2대</td><td>18억</td></tr><tr><td>대학병원역</td><td>공용 대합실 아래 상·하행 승강장이 선로 양쪽에 분리</td><td>지상↔공용대합실 1대 + 상행 승강장 1대 + 하행 승강장 1대</td><td>3대</td><td>39억</td></tr><tr><td>전통시장역</td><td>하나의 섬식 승강장</td><td>지상↔대합실 1대 + 대합실↔승강장 1대</td><td>2대</td><td>20억</td></tr><tr><td>푸른공원역</td><td>하나의 섬식 승강장</td><td>지상↔대합실 1대 + 대합실↔승강장 1대</td><td>2대</td><td>18억</td></tr><tr><td>새봄고역</td><td>대합실↔승강장 기존 엘리베이터 사용 가능</td><td>지상↔대합실 1대만 추가</td><td>1대</td><td>8억</td></tr></tbody></table></div><p class="help">대학병원역은 ‘양쪽 승강장을 한 엘리베이터로 연결한다’는 뜻이 아닙니다. <b>공용 대합실까지 1대가 필요하고, 선로 양쪽에 분리된 상·하행 승강장에는 각각 별도의 1대가 필요해 총 3대</b>가 되는 구조입니다.</p></div>`;
 if(id==='usage')return `<div class="resourceVisual"><h3>📊 후보역 하루 이용 현황</h3><div class="tablewrap"><table><thead><tr><th>역</th><th>전체 이용객</th><th>교통약자 추정</th><th>교통약자 비율</th><th>자료에서 보이는 특징</th></tr></thead><tbody><tr><td>새봄중앙역</td><td>18,400명</td><td>1,850명</td><td>10.1%</td><td>전체 이용객·환승 수요 가장 큼</td></tr><tr><td>복지센터역</td><td>8,900명</td><td>1,620명</td><td>18.2%</td><td>교통약자 비율 가장 높음</td></tr><tr><td>대학병원역</td><td>15,700명</td><td>2,140명</td><td>13.6%</td><td>교통약자 추정 인원 가장 많음</td></tr><tr><td>전통시장역</td><td>11,200명</td><td>1,480명</td><td>13.2%</td><td>고령층·생활형 이동 수요</td></tr><tr><td>푸른공원역</td><td>7,200명</td><td>780명</td><td>10.9%</td><td>현 단계에서 비교적 낮은 수요</td></tr><tr><td>새봄고역</td><td>9,600명</td><td>510명</td><td>5.3%</td><td>교통약자 규모는 작지만 낮은 비용</td></tr></tbody></table></div><p class="help">‘전체 이용객 수가 많은 역’과 ‘교통약자의 필요가 큰 역’이 반드시 같지는 않습니다. 어떤 기준을 더 중요하게 볼지 생각해 보세요.</p></div>`;
 if(id==='map')return `<div class="resourceVisual"><h3>🗺️ 역 주변 주요 시설과 이동 목적</h3><div class="facilityGrid"><div class="facilityCard"><b>🏛️ 새봄중앙역</b><p>새봄시청 320m<br>환승버스센터 80m</p></div><div class="facilityCard"><b>♿ 복지센터역</b><p>장애인종합복지관 180m<br>시립복지지원센터 260m</p></div><div class="facilityCard"><b>🏥 대학병원역</b><p>새봄대학교병원 220m<br>응급의료센터</p></div><div class="facilityCard"><b>🏪 전통시장역</b><p>새봄전통시장 90m<br>노인복지관 350m</p></div><div class="facilityCard"><b>🌳 푸른공원역</b><p>푸른공원 120m<br>생활체육센터 240m</p></div><div class="facilityCard"><b>🏫 새봄고역</b><p>새봄고등학교 140m<br>특수학급 통학로</p></div></div><p class="help">같은 1명의 이동이라도 <b>진료·복지·통학·환승·생활·여가</b>처럼 목적의 필수성이 다를 수 있습니다.</p></div>`;
 if(id==='voices')return `<div class="resourceVisual"><h3>💬 시민·이용자 의견 — 구체적인 목소리</h3><p class="small muted">위 이미지가 시민의 ‘상황’을 정리했다면, 아래 발언은 그 상황이 실제 이동에서 어떤 불편과 요구로 이어지는지 보여줍니다.</p><div class="voiceGrid"><div class="voiceCard"><b>♿ 휠체어 이용 시민 · 복지센터역</b>“복지센터 수업이 있는 날에는 계단을 피하려고 두 정거장 전에 내려 택시를 탑니다. 이동시간과 교통비가 매번 더 듭니다.”</div><div class="voiceCard"><b>🏥 대학병원 이용 보호자 · 대학병원역</b>“재활치료가 끝난 뒤에는 환자가 더 지쳐 있습니다. 그 상태에서 계단을 오르내리게 하는 것이 가장 걱정됩니다.”</div><div class="voiceCard"><b>🏪 전통시장 상인 · 전통시장역</b>“장보기 짐을 든 고령 손님이 계단 앞에서 돌아가는 경우가 있습니다. 시장뿐 아니라 노인복지관 이동도 함께 봐주면 좋겠습니다.”</div><div class="voiceCard"><b>🧑‍💼 통근 시민 · 새봄중앙역</b>“매일 많은 사람이 환승하는 역도 중요합니다. 다만 이용객 수만으로 정하지 말고 더 절박한 이동이 어디인지도 비교해야 합니다.”</div><div class="voiceCard"><b>🎒 새봄고 학생 · 새봄고역</b>“특수학급 친구가 등하교할 때 다른 사람의 도움 없이 학교까지 이어서 이동할 수 있었으면 좋겠습니다.”</div><div class="voiceCard"><b>🧑‍🍼 유모차 이용 보호자 · 푸른공원역</b>“아이와 짐을 함께 들고 계단을 이용하기 어렵습니다. 가족 이동도 생활 속 접근성 문제라고 생각합니다.”</div></div><p class="help">시민 의견은 ‘정답’을 알려주는 자료가 아닙니다. <b>수치·거리·시설·비용 자료와 함께 비교</b>하여 누구의 필요를 먼저 고려할지 판단하세요.</p></div>`;
